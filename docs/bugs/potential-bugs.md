...
### 3. Audio queue overflow silently drops frames
...
### 4. Wake word retriggering can bypass silence detection indefinitely
...
### 5. Stop command substring matching triggers on unrelated phrases
...
### 6. Linear resampler state not thread-safe
...
### 10. WebSocket session timeout handling suboptimal
...
### 11. No bounds checking on audio format assumptions
...
### 12. Potential division by zero in chunk duration calculation
...
### 13. Missing error context in event receiver exception handling
