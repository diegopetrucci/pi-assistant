...
- [ ] `src/pi_assistant/cli/controller.py:229` — same as above for the `force_always_on` key.
...
- [ ] `src/pi_assistant/cli/controller.py:362` — same check for `force_always_on`.
...
- [ ] `src/pi_assistant/cli/controller.py:401` — same check for the `force_always_on`.
...
- [ ] `src/pi_assistant/cli/controller.py:429` — same check for the `force_always_on`.
...
- [ ] `src/pi_assistant/cli/controller.py:473` — same guard for the `force_always_on`.
