...
from pi_assistant.assistant.session.services.assistant_prep_service import (
...
async def test_assistant_prep_service_warms_and_announces_responses_audio(
    ...
    monkeypatch.setattr(
        "pi_assistant.assistant.session.services.assistant_prep_service.CONFIRMATION_CUE_ENABLED",
        True,
        raising=False,
    )
    monkeypatch.setattr(
        "pi_assistant.assistant.session.services.assistant_prep_service.CONFIRMATION_CUE_TEXT",
        "Ready when you are",
        raising=False,
    )
...
async def test_assistant_prep_service_logs_cue_cleanup_errors(
    ...
    monkeypatch.setattr(
        "pi_assistant.assistant.session.services.assistant_prep_service.LOGGER.log",
        capture_log,
    )
