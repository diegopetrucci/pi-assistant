...
from pi_assistant.audio import wake_word
from pi_assistant.audio.wake_word import WakeWordEngine
...
class WakeWordEngineTest(unittest.TestCase):
    ...
    def test_detects_hey_jarvis_once(self):
        ...
        jarvis_model = Path("models/wake_word/hey_jarvis_v0.1.onnx")
        jarvis_fallback = Path("models/wake_word/hey_jarvis_v0.1.tflite")
