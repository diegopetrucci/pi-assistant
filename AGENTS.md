...
* Whenever you add or change CLI flags, configuration keys, assistant behavior, or setup steps, update the references in `README.md` (usage + configuration sections), document canonical details in `docs/cli.md`, and keep any long-form writeups in `docs/`.
